module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('reminders', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('bills', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('reminders', 'billId', { transaction });

      await queryInterface.removeColumn('reminders', 'message', {
        transaction,
      });

      await queryInterface.removeColumn('reminders', 'reminder_date', {
        transaction,
      });

      await queryInterface.removeColumn('bills', 'userId', { transaction });

      await queryInterface.removeColumn('bills', 'status', { transaction });

      await queryInterface.removeColumn('bills', 'due_date', { transaction });

      await queryInterface.removeColumn('bills', 'amount', { transaction });

      await queryInterface.removeColumn('bills', 'bill_name', { transaction });
