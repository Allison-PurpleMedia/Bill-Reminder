...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/bills/billsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBillsCols';
...
const TableSampleBills = ({
  ...
  const {
    ...
    notify: billsNotify,
    refetch,
  } = useAppSelector((state) => state.bills);
  ...
  useEffect(() => {
    if (billsNotify.showNotification) {
      notify(billsNotify.typeNotification, billsNotify.textNotification);
    }
  }, [billsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/bills/bills-view/?id=${id}`);
  };
...
export default TableSampleBills;
