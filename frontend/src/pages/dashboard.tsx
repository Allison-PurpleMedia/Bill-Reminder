...
const Dashboard = () => {
  ...
  const [bills, setBills] = React.useState('Loading...');
  const [reminders, setReminders] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_BILLS') && (
          ...
          {hasPermission(currentUser, 'READ_REMINDERS') && (
