...
import { create } from '../../stores/reminders/remindersSlice';
        ...
        <CardBox>
          ...
          >
            <Form>
              ...
              <FormField label='Bill' labelFor='bill'>
                <Field
                  name='bill'
                  id='bill'
...
RemindersNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_REMINDERS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default RemindersNew;
